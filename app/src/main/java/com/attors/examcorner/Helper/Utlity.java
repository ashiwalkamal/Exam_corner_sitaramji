package com.attors.examcorner.Helper;
...
import com.attors.examcorner.Activity.Login;
import com.attors.examcorner.Activity.MainActivity;
import com.attors.examcorner.BuildConfig;
import com.attors.examcorner.Modal.Keymodal;
...
public class Utlity {
    ...
    public static void Set_image(String url, ImageView img) {
        if (!TextUtils.isEmpty(url));
           // Picasso.get().load(url).error(R.drawable.ic_boy).placeholder(R.drawable.ic_boy).into(img);
    }
